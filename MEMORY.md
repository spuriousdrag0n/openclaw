# MEMORY.md - RedQueen Long-Term Memory
...
- Sending messages via WhatsApp (to any recipient)
- Executing scripts, code, or commands
- File system modifications (write, edit, delete)
