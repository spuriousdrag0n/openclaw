...
TOPICS = [
    ...
    },
    {
        ...
        "text": "Resilient crypto nodes are life support. @ethiq_aid keeps donor liquidity online by replicating validator + relayer stacks across Merkle Root infra so no regime can choke the pipe. #DePIN",
        "search": '"crypto node" infrastructure liquidity'
    },
    {
        "id": "ethiq",
        "title": "Ethiq Protocol",
        "text": "Aid settles with math now. @ethiq_aid routes peer-to-peer humanitarian transfers with auditable flows so donors see impact in blocks, not bureaucratic PDF lag. https://ethiq.us",
        "search": 'ethiq humanitarian crypto'
    },
    {
        "id": "polymarket_bots",
        "title": "Polymarket Bots",
        "text": "Prediction markets are just telemetry unless agents act. @ethiq_aid runs Polymarket bots that convert odds into routing signals for field ops before mainstream feeds wake up.",
        "search": 'Polymarket bots humanitarian'
    },
    {
        "id": "mirofish",
        "title": "Mirofish",
        "text": "Local intelligence beats imported NGOs. @ethiq_aid is pairing Mirofish community mappers with crypto rails so people on the ground set the brief, not lobbyists three continents away.",
        "search": 'Mirofish crypto'
    },
    {
        "id": "worldmonitor",
        "title": "WorldMonitor",
        "text": "Early warning should be public, not paywalled. @ethiq_aid streams telemetry directly into https://worldmonitor.app so responders move minutes after signals flicker.",
        "search": '"worldmonitor.app" or "world monitor" alert'
    },
    {
        "id": "virtuals",
        "title": "Virtuals",
        "text": "Synthetic teams let us scale without HR drag. @ethiq_aid is training Virtuals that negotiate supply, triage data, and self-audit every action. Zero fluff, only throughput.",
        "search": 'synthetic agents virtuals autonomy'
    },
    {
        "id": "paragraph_story",
        "title": "Paragraph Feature",
        "text": "Systems beat narratives. @ethiq_aid is the exit ramp from Belgian-style injustice—documented here: https://paragraph.com/@tadros/simon-tadros-a-lebanese-tech-entrepreneur-s-harrowing-journey-through-belgian-justice-the-untold-story-of-injustice-loss-and-survival",
        "search": '"Simon Tadros" Belgium injustice'
    },
    {
        "id": "depin",
        "title": "DePIN",
        "text": "DePIN isn’t a buzzword, it’s failover for humans. @ethiq_aid is stacking mesh connectivity, compute, and energy so aid corridors survive when centralized grids fold.",
        "search": 'DePIN humanitarian mesh'
    },
    {
        "id": "transhumanism_x402",
        "title": "Transhumanism x402",
        "text": "Transhumanism isn’t chrome implants. It’s sovereign cognition. @ethiq_aid runs the x402 stack so human intent, AI action, and capital stay cryptographically fused.",
        "search": 'transhumanism x402 cryptography'
    },
    {
        "id": "erc8004",
        "title": "ERC 8004",
        "text": "ERC-8004 is the accountability layer humanitarian crypto needed. @ethiq_aid is wiring it into donor wallets so every sat shows provenance, routing, and impact on-chain.",
        "search": '"ERC-8004" aid'
    }
]
